...
ifeq ($(ENV), debug)
	CXXFLAGS += -DIGNORE_LOCKS=true -DENABLE_STAGE_BREAK=false -DENABLE_BACKGROUND=false -DAUDIO_LAG=180
else ifeq ($(ENV), development)
	CXXFLAGS += -DIGNORE_LOCKS=true -DENABLE_STAGE_BREAK=false -DENABLE_BACKGROUND=true -DAUDIO_LAG=180
else
	CXXFLAGS += -DIGNORE_LOCKS=false -DENABLE_STAGE_BREAK=true -DENABLE_BACKGROUND=true -DAUDIO_LAG=0
endif
